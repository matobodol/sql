...
impl Schema {
    ...
    pub fn validate_schema_columns(columns: &[ColumnDef]) -> Result<(), DomainError> {
    ...
    pub fn validate_row(&self, values: &[SqlValue]) -> Result<(), DomainError> {
        ...
        // Gunakan Row::with_id dengan RowId dummy (0) khusus untuk evaluasi CHECK constraint
        let temp_row = Row::with_id(crate::RowId::from(0u64), values.to_vec());
